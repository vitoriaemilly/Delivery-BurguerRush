...
// const json_cidades = ('https://servicodados.ibge.gov.br/api/v1/localidades/municipios')

// json_cidades.filter(function(p){
//    document.querySelector("#cidade").innerHTML = '';document.querySelector
